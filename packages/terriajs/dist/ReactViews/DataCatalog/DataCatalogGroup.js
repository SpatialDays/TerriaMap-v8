...
const DataCatalogGroup = observer(createReactClass({
    ...
    render() {
        ...
        return (React.createElement(CatalogGroup, { text: this.getNameOrPrettyUrl(), isPrivate: group.isPrivate, title: getPath(this.props.group, " → "), topLevel: this.props.isTopLevel, open: this.isOpen(), loading: group.isLoading || group.isLoadingMembers, emptyMessage: t("dataCatalog.groupEmpty"), onClick: this.clickGroup, removable: this.props.removable, removeUserAddedData: removeUserAddedData.bind(this, this.props.terria, this.props.group), selected: this.isSelected(), 
            ...
            }, allItemsLoaded: allMappableMembersInWorkbench(this.props.group.members, this.props.terria) },
            React.createElement(If, { condition: this.isOpen() },
                React.createElement(For, { each: "item", of: group.memberModels },
                    React.createElement(DataCatalogMember, { key: item.uniqueId, member: item, terria: this.props.terria, viewState: this.props.viewState, userData: this.props.userData, overrideOpen: this.props.manageIsOpenLocally, onActionButtonClicked: this.props.onActionButtonClicked })))));
    }
}));
